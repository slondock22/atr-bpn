@section('title','Pertanyaan Portal')
                  ...
                  <ul class="tb-horizontal-list tb-style1 tb-mp0">
                    @if(isset($stats['data']))
                      @for($i=0; $i < count($stats['data']); $i++)
                        ...
                        @if($stats['data'][$i]['type'] == 'portal')
                        <li>
                          <div class="tb-list-title">Total</div>
                          <div class="tb-list-number">
                            <a href="{{url('aduan/portal')}}">{{$stats['data'][$i]['TOTAL']}}
                            </a>
                          </div>
                        </li>
                        <li>
                          ...
                          <div class="tb-list-number">
                            <a href="{{url('aduan/portal?type=yet')}}">
                            {{$stats['data'][$i]['BELUM']}}
                            </a>
                          </div>
                        </li>
                        <li>
                          ...
                          <div class="tb-list-number">
                            <a href="{{url('aduan/portal?type=process')}}">
                            {{$stats['data'][$i]['PROSES']}}
                            </a>
                          </div>
                        </li>
                        <li>
                          ...
                          <div class="tb-list-number">
                            <a href="{{url('aduan/portal?type=terjawab')}}">
                        ...
                        <li>
                          ...
                          <div class="tb-list-number">
                            <!-- <a href="{{url('aduan/portal?type=spam')}}"> -->
                            {{$stats['data'][$i]['SPAM']}}
                            <!-- </a> -->
                          </div>
                        </li>
            ...
            <div class="tb-card tb-style1 tb-height-auto">
              ...
              <div class="tb-card-body">
                <div class="tb-padd-lr-30">
                  ...
                  <form method="GET" action="{{route('aduan','portal')}}" id="formFilter" name="formFilter">
                  <!--   @csrf -->
                  <div class="form-row">
        ...
        <form id="frmDisposisi" name="frmDisposisi" action="{{route('postComment')}}" method="POST">
          @csrf
           <div class="tb-height-lg-b20"></div>
            ...
            <input type="hidden" id="type_aduan" value="portal" name="type_aduan">
