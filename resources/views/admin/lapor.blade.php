@section('title','Pertanyaan Lapor')
...
<div class="tb-content tb-style1 tab-profil-content">
  <div class="tb-padd-lr-30 tb-uikits-heading">
      <h2 class="tb-uikits-title">Aplikasi Lapor</h2>
                  ...
                  <ul class="tb-horizontal-list tb-style1 tb-mp0">
                    @if(isset($stats['data']))
                      @for($i=0; $i < count($stats['data']); $i++)
                        ...
                        @if($stats['data'][$i]['type'] == 'lapor')
                        <li>
                          <div class="tb-list-title">Total</div>
                          <div class="tb-list-number">
                            <a href="{{url('aduan/lapor')}}">{{$stats['data'][$i]['TOTAL']}}
                            </a>
                          </div>
                        </li>
                        <li>
                          ...
                          <div class="tb-list-number">
                            <a href="{{url('aduan/lapor?type=yet')}}">
                            {{$stats['data'][$i]['BELUM']}}
                            </a>
                          </div>
                        </li>
                        <li>
                          ...
                          <div class="tb-list-number">
                            <a href="{{url('aduan/lapor?type=process')}}">
                            {{$stats['data'][$i]['PROSES']}}
                            </a>
                          </div>
                        </li>
                        <li>
                          ...
                          <div class="tb-list-number">
                            <a href="{{url('aduan/lapor?type=terjawab')}}">
                        ...
                        <li>
                          ...
                          <div class="tb-list-number">
                            <!-- <a href="{{url('aduan/lapor?type=spam')}}"> -->
                            {{$stats['data'][$i]['SPAM']}}
                            <!-- </a> -->
                          </div>
                        </li>
            ...
            <div class="tb-card tb-style1 tb-height-auto">
              ...
              <div class="tb-card-body">
                <div class="tb-padd-lr-30">
                  ...
                  <form method="GET" action="{{route('aduan','lapor')}}" id="formFilter" name="formFilter">
                  <!--   @csrf -->
                  <div class="form-row">
        ...
        <form id="frmDisposisi" name="frmDisposisi" action="{{route('postComment')}}" method="POST">
          @csrf
           <div class="tb-height-lg-b20"></div>
            ...
            <input type="hidden" id="type_aduan" value="lapor" name="type_aduan">
        ...
        <form id="frmTambahAduanManual" name="frmTambahAduanManual" action="{{route('tambahAduanManual')}}" method="POST">
                  @csrf
                   <div class="tb-height-lg-b20"></div>
                    ...
                    <input type="hidden" name="aduan_type" id="aduan_type" value="lapor">
