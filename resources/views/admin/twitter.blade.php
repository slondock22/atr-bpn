                      ...
                      @for($i=0; $i < count($stats['data']); $i++)
                        ...
                        <li>
                          ...
                          <div class="tb-list-number">
                            <a href="{{url('aduan/twitter')}}">{{$stats['data'][$i]['TOTAL']}}
                            </a>
                          </div>
                        </li>
                        <li>
                          ...
                          <div class="tb-list-number">
                            <a href="{{url('aduan/twitter?type=yet')}}">
                            {{$stats['data'][$i]['BELUM']}}
                            </a>
                          </div>
                        </li>
                        <li>
                          ...
                          <div class="tb-list-number">
                            <a href="{{url('aduan/twitter?type=process')}}">
                            {{$stats['data'][$i]['PROSES']}}
                            </a>
                          </div>
                        </li>
                        <li>
                          ...
                          <div class="tb-list-number">
                            <a href="{{url('aduan/twitter?type=terjawab')}}">
                        ...
                        <li>
                          ...
                          <div class="tb-list-number">
                            <!-- <a href="{{url('aduan/twitter?type=spam')}}"> -->
                            {{$stats['data'][$i]['SPAM']}}
                            <!-- </a> -->
                          </div>
                        </li>
        ...
        <form id="frmDisposisi" name="frmDisposisi" action="{{route('postComment')}}" method="POST">
          @csrf
           <div class="tb-height-lg-b20"></div>
            ...
            <input type="hidden" id="type_aduan" value="twitter" name="type_aduan">
