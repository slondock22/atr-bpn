...
<div class="modal fade" id="modal-add-disposisi" tabindex="-1" role="dialog" aria-labelledby="myLargeModalLabel" aria-hidden="true">
  <div class="modal-dialog modal-dialog-centered modal-facebook">
    <div class="modal-content">
      <div class="modal-header">
        <h5 class="modal-title" id="myLargeModalLabel">
          <i class="lni lni-facebook-original icon-tweet"></i> #Disposisi
        </h5>
        ...
        <form id="frmDisposisi" name="frmDisposisi" action="{{route('postComment')}}" method="POST">
          @csrf
           <div class="tb-height-lg-b20"></div>
            ...
            <div id="contentTwitUserDisposisi" class="divContentFacebook"></div>

            <hr class="hrModal">
            <input type="hidden" id="idFeeds" value="" name="idFeeds">
            <input type="hidden" id="type_aduan" value="facebook" name="type_aduan">
            ...
            <div class="form-group">
              ...
              <textarea class="form-control text-area-modal-facebook-nopad" id="commentDisposisi" rows="3" placeholder="Isikan keterangan disposisi" name="comment" required=""></textarea>
            </div>
      ...
      <div class="modal-footer">
        ...
        <button type="button" class="btn btn-modal-facebook-danger" data-dismiss="modal">Batal</button>
        <button type="button" id="btnSendDisposisi" id="btnSendDisposisi" class="btn btn-modal-facebook" onclick="serviceSend('#frmDisposisi')">Kirim</button>
      </div>
    </div>
  </div>
</div>
  ...
  <div class="modal-dialog modal-dialog-centered modal-lg">
    <div class="modal-content">
      <div class="modal-header modal-header-sos">
        <h5 class="modal-title" id="myLargeModalLabel">
          <i class="lni lni-facebook-original icon-tweet"></i> Jenis Aduan ATR/BPN
        </h5>
        <button type="button" class="close" data-dismiss="modal" aria-label="Close">
          <span aria-hidden="true">×</span>
        </button>
                ...
                <table class="table" style="min-width: 100% !important">
                  ...
                  @if(isset($aduan['data']))
                    ...
                    <tr>
                      ...
                      <td>
                        <button type="button" class="btn btn-modal-facebook" onclick="change_hastag('#{{$value['description']}}','{{$value['id']}}')">Pilih</button>
                      </td>
                     </tr>
                     @endforeach
                    @endif
...
<div class="modal fade" id="modal-balas-feed" tabindex="-1" role="dialog" aria-labelledby="myLargeModalLabel" aria-hidden="true">
  <div class="modal-dialog modal-lg modal-dialog-centered modal-facebook">
    <div class="modal-content">
      <div class="modal-header modal-header-sos">
        <h5 class="modal-title" id="myLargeModalLabel">
          <i class="lni lni-facebook-original icon-tweet"></i> Balas Feeds
        </h5>
        <button type="button" class="close" data-dismiss="modal" aria-label="Close">
          <span aria-hidden="true">×</span>
        </button>
      ...
      <div class="modal-body">
         <form>
            <div class="form-group">
              ...
              <div id="contentTwitUser" class="divContentFacebook"></div>
              ...
              <textarea class="form-control text-area-modal-facebook" id="inputSendModalFeeds"  
    ...
    <div class="modal-footer">
        <button type="button" class="btn btn-modal-facebook-danger" data-dismiss="modal">Batal</button>
        {{-- <button type="button" class="btn btn-modal-facebook">Draft</button> --}}
        <button type="button" onclick="iframePost('#iframePostId','#inputSendModalFeeds')" class="btn btn-modal-facebook">Kirim</button>
      </div>
  </div>
</div>
</div>
...
<div class="modal fade" id="modal-loadmore" tabindex="-1" role="dialog" aria-labelledby="myLargeModalLabel" aria-hidden="true">
  <div class="modal-dialog modal-lg modal-dialog-centered modal-facebook">
    <div class="modal-content">
      <div class="modal-header modal-header-sos">
        <h5 class="modal-title" id="myLargeModalLabel">
          <i class="lni lni-facebook-original icon-tweet"></i> All Comment
        </h5>
        <button type="button" class="close" data-dismiss="modal" aria-label="Close">
          <span aria-hidden="true">×</span>
        </button>
      ...
      <div class="modal-footer">
        <button type="button" class="btn btn-modal-facebook-danger" data-dismiss="modal">
          Tutup
        </button>
      </div>
      </div>
...
<div class="modal fade" id="modal-iframepost" tabindex="-1" role="dialog" aria-labelledby="myLargeModalLabel" aria-hidden="true">
  <div class="modal-dialog modal-xxl modal-dialog-centered modal-xxl-top">
    <div class="modal-content">
      <div class="modal-header modal-header-sos">
        <h5 class="modal-title" id="myLargeModalLabel">
          <i class="lni lni-facebook-original icon-tweet"></i> Posting Jawaban
        </h5>
        <button type="button" class="close" data-dismiss="modal" aria-label="Close">
          <span aria-hidden="true">×</span>
        </button>
 ...
 <div class="modal fade" id="modal-confirm-delete" tabindex="-1" role="dialog" aria-labelledby="myLargeModalLabel" aria-hidden="true" style="z-index: 1052">
  <div class="modal-dialog modal-lg modal-dialog-centered modal-facebook">
    <div class="modal-content" style="box-shadow: grey 0px 0px 550px 0px">
      <div class="modal-header modal-header-sos">
        <h5 class="modal-title" id="myLargeModalLabel">
          <i class="lni lni-facebook-original icon-tweet"></i> Konfirmasi Hapus Disposisi
        </h5>
        <button type="button" class="close" data-dismiss="modal" aria-label="Close">
          <span aria-hidden="true">×</span>
        </button>
      ...
      <div class="modal-footer">
        ...
        <button type="button" class="btn btn-modal-facebook" onclick="deleteDisposisi()">
          Hapus
        </button>
      </div>
      </div>
