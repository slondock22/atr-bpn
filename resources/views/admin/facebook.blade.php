    ...
    <div class="modal-content">
      <div class="modal-header">
        <h5 class="modal-title" id="myLargeModalLabel">
          <i class="lni lni-facebook-original icon-facebook"></i> #Disposisi
        </h5>
  ...
  <div class="modal-dialog modal-dialog-centered modal-lg">
    <div class="modal-content">
      <div class="modal-header modal-header-sos">
        <h5 class="modal-title" id="myLargeModalLabel">
          <i class="lni lni-facebook-original icon-facebook"></i> Jenis Aduan ATR/BPN
        </h5>
        <button type="button" class="close" data-dismiss="modal" aria-label="Close">
          <span aria-hidden="true">×</span>
        </button>
                ...
                <table class="table" style="min-width: 100% !important">
                  ...
                  <tbody>
                   <tr>
                      ...
                      <td>
                        <button type="button" class="btn btn-modal-facebook" onclick="change_hastag('#SengketaTanah')">Pilih</button>
                      </td>
                    </tr>
                    <tr>
                      ...
                      <td>
                        <button type="button" class="btn btn-modal-facebook" onclick="change_hastag('#PenataanTataRuang')">Pilih</button>
                      </td>
                    </tr>
                    <tr>
                      <td>
                      ...
                      <td>
                        <button type="button" class="btn btn-modal-facebook" onclick="change_hastag('#infrastrukturAgraria')">Pilih</button>
                      </td>
                    </tr>
                    <tr>
                      <td>
                      ...
                      <td>
                          <button type="button" class="btn btn-modal-facebook" onclick="change_hastag('#HubunganHukumAgraria')">Pilih</button>
                      </td>
                    </tr>
                    <tr>
                      <td>
                      ...
                      <td>
                          <button type="button" class="btn btn-modal-facebook" onclick="change_hastag('#PengadaanTanah')">Pilih</button>
                      </td>
                    </tr>
                    <tr>
                      <td>
                      ...
                      <td>
                          <button type="button" class="btn btn-modal-facebook" onclick="change_hastag('#PengendalianPenguasaanTanah')">Pilih</button>
                      </td>
                    </tr>
                    <tr>
                      <td>
                      ...
                      <td>pengawasan atas pelaksanaan tugas di lingkungan BPN</td>
                      <td>
                        <button type="button" class="btn btn-modal-facebook" onclick="change_hastag('#HakTanahMasyarakat')">Pilih</button>
                      </td>
                    </tr>
                    <tr>
                      <td>
                      ...
                      <td>pelaksanaan pengembangan sumber daya manusia di bidang pertanahan</td>
                      <td>
                        <button type="button" class="btn btn-modal-facebook" onclick="change_hastag('#EkonomiPertanahan')">Pilih</button>
                      </td>
                    </tr>
                  </tbody>
                </table>
...
<div class="modal fade" id="modal-balas-feed" tabindex="-1" role="dialog" aria-labelledby="myLargeModalLabel" aria-hidden="true">
  <div class="modal-dialog modal-lg modal-dialog-centered modal-twitter">
    <div class="modal-content">
      <div class="modal-header modal-header-sos">
        <h5 class="modal-title" id="myLargeModalLabel">
          <i class="lni lni-facebook-original icon-facebook"></i> Balas Feeds
        </h5>
        <button type="button" class="close" data-dismiss="modal" aria-label="Close">
          <span aria-hidden="true">×</span>
        </button>
         ...
         <form>
            <div class="form-group">
              ...
              <textarea class="form-control text-area-modal-twitter" id="inputSendModalFeeds" 
                rows="3" placeholder="Tulis Komentar Anda" autofocus></textarea>
            </div>
    ...
    <div class="modal-footer">
        ...
        <button type="button" class="btn btn-modal-facebook">Kirim</button>
      </div>
  </div>
</div>
<!-- End Large Mosal -->
