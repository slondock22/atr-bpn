                    ...
                    @if(isset($stats['data']))
                      @for($i=0; $i < count($stats['data']); $i++)
                        ...
                        <li>
                          ...
                          <div class="tb-list-number">
                            <a href="{{url('aduan/youtube?type=yet')}}">
                            {{$stats['data'][$i]['BELUM']}}
                            </a>
                          </div>
                        </li>
                        <li>
                          ...
                          <div class="tb-list-number">
                            <a href="{{url('aduan/youtube?type=process')}}">
                            {{$stats['data'][$i]['PROSES']}}
                            </a>
                          </div>
                        </li>
                        <li>
                          ...
                          <div class="tb-list-number">
                            <a href="{{url('aduan/youtube?type=terjawab')}}">
                        ...
                        <li>
                          ...
                          <div class="tb-list-number">
                            <!-- <a href="{{url('aduan/youtube?type=spam')}}"> -->
                            {{$stats['data'][$i]['SPAM']}}
                            <!-- </a> -->
                          </div>
                        </li>
                  ...
                  <div class="tb-user tb-style3">
                    ...
                    <div class="tb-user-info">
                      <h3 class="tb-user-name">
                        ...
                        <span class="doneSpan">
                           <i class="fas fa-check-circle doneIconYoutube"></i>
                           Aduan Terjawab
                        </span>
                        @else
                        <span class="doneSpan">
...
<div class="modal fade" id="modal-add-disposisi" tabindex="-1" role="dialog" aria-labelledby="myLargeModalLabel" aria-hidden="true">
  <div class="modal-dialog modal-dialog-centered modal-youtube">
    <div class="modal-content">
      <div class="modal-header">
        <h5 class="modal-title" id="myLargeModalLabel">
          <i class="lni lni-youtube-original icon-tweet"></i> #Disposisi
        </h5>
        ...
        <form id="frmDisposisi" name="frmDisposisi" action="{{route('postComment')}}" method="POST">
          @csrf
           <div class="tb-height-lg-b20"></div>
            ...
            <div id="contentTwitUserDisposisi" class="divContentYoutube"></div>
            ...
            <div class="form-group">
              ...
              <textarea class="form-control text-area-modal-youtube-nopad" id="commentDisposisi" rows="3" placeholder="Isikan keterangan disposisi" name="comment" required=""></textarea>
            </div>
  ...
  <div class="modal-dialog modal-dialog-centered modal-lg">
    <div class="modal-content">
      <div class="modal-header modal-header-sos">
        <h5 class="modal-title" id="myLargeModalLabel">
          <i class="lni lni-youtube-original icon-tweet"></i> Jenis Aduan ATR/BPN
        </h5>
        <button type="button" class="close" data-dismiss="modal" aria-label="Close">
          <span aria-hidden="true">×</span>
        </button>
                ...
                <table class="table" style="min-width: 100% !important">
                  ...
                  @if(isset($aduan['data']))
                    ...
                    <tr>
                      ...
                      <td>
                        <button type="button" class="btn btn-modal-youtube" onclick="change_hastag('#{{$value['description']}}','{{$value['id']}}')">Pilih</button>
                      </td>
                     </tr>
                     @endforeach
                    @endif
...
<div class="modal fade" id="modal-balas-feed" tabindex="-1" role="dialog" aria-labelledby="myLargeModalLabel" aria-hidden="true">
  <div class="modal-dialog modal-lg modal-dialog-centered modal-youtube">
    <div class="modal-content">
      <div class="modal-header modal-header-sos">
        <h5 class="modal-title" id="myLargeModalLabel">
          <i class="lni lni-youtube-original icon-tweet"></i> Balas Feeds
        </h5>
        <button type="button" class="close" data-dismiss="modal" aria-label="Close">
          <span aria-hidden="true">×</span>
        </button>
      ...
      <div class="modal-body">
         <form>
            <div class="form-group">
              ...
              <div id="contentTwitUser" class="divContentYoutube"></div>
              ...
              <textarea class="form-control text-area-modal-youtube" id="inputSendModalFeeds"  
    ...
    <div class="modal-footer">
        <button type="button" class="btn btn-modal-youtube-danger" data-dismiss="modal">Batal</button>
        {{-- <button type="button" class="btn btn-modal-youtube">Draft</button> --}}
        <button type="button" onclick="iframePost('#iframePostId','#inputSendModalFeeds')" class="btn btn-modal-youtube">Kirim</button>
      </div>
  </div>
</div>
</div>
...
<div class="modal fade" id="modal-loadmore" tabindex="-1" role="dialog" aria-labelledby="myLargeModalLabel" aria-hidden="true">
  <div class="modal-dialog modal-lg modal-dialog-centered modal-youtube">
    <div class="modal-content">
      <div class="modal-header modal-header-sos">
        <h5 class="modal-title" id="myLargeModalLabel">
          <i class="lni lni-youtube-original icon-tweet"></i> All Comment
        </h5>
        <button type="button" class="close" data-dismiss="modal" aria-label="Close">
          <span aria-hidden="true">×</span>
        </button>
      ...
      <div class="modal-footer">
        <button type="button" class="btn btn-modal-youtube-danger" data-dismiss="modal">
          Tutup
        </button>
      </div>
      </div>
...
<div class="modal fade" id="modal-iframepost" tabindex="-1" role="dialog" aria-labelledby="myLargeModalLabel" aria-hidden="true">
  <div class="modal-dialog modal-dialog-centered modal-xxl modal-xxl-top">
    <div class="modal-content">
      <div class="modal-header modal-header-sos">
        <h5 class="modal-title" id="myLargeModalLabel">
          <i class="lni lni-youtube-original icon-tweet"></i> Posting Jawaban
        </h5>
        <button type="button" class="close" data-dismiss="modal" aria-label="Close">
          <span aria-hidden="true">×</span>
        </button>
 ...
 <div class="modal fade" id="modal-confirm-delete" tabindex="-1" role="dialog" aria-labelledby="myLargeModalLabel" aria-hidden="true" style="z-index: 1052">
  <div class="modal-dialog modal-lg modal-dialog-centered modal-youtube">
    <div class="modal-content" style="box-shadow: grey 0px 0px 550px 0px">
      <div class="modal-header modal-header-sos">
        <h5 class="modal-title" id="myLargeModalLabel">
          <i class="lni lni-youtube-original icon-tweet"></i> Konfirmasi Hapus Disposisi
        </h5>
        <button type="button" class="close" data-dismiss="modal" aria-label="Close">
          <span aria-hidden="true">×</span>
        </button>
      ...
      <div class="modal-footer">
        ...
        <button type="button" class="btn btn-modal-youtube" onclick="deleteDisposisi()">
          Hapus
        </button>
      </div>
      </div>
