@section('title','Pertanyaan Pengaduan Langsung')
...
<div class="tb-content tb-style1 tab-profil-content">
  <div class="tb-padd-lr-30 tb-uikits-heading">
      <h2 class="tb-uikits-title">Pengaduan Langsung</h2>
                  ...
                  <ul class="tb-horizontal-list tb-style1 tb-mp0">
                    @if(isset($stats['data']))
                      @for($i=0; $i < count($stats['data']); $i++)
                        ...
                        @if($stats['data'][$i]['type'] == 'langsung')
                        <li>
                          <div class="tb-list-title">Total</div>
                          <div class="tb-list-number">
                            <a href="{{url('aduan/langsung')}}">{{$stats['data'][$i]['TOTAL']}}
                            </a>
                          </div>
                        </li>
                        <li>
                          ...
                          <div class="tb-list-number">
                            <a href="{{url('aduan/langsung?type=yet')}}">
                            {{$stats['data'][$i]['BELUM']}}
                            </a>
                          </div>
                        </li>
                        <li>
                          ...
                          <div class="tb-list-number">
                            <a href="{{url('aduan/langsung?type=process')}}">
                            {{$stats['data'][$i]['PROSES']}}
                            </a>
                          </div>
                        </li>
                        <li>
                          ...
                          <div class="tb-list-number">
                            <a href="{{url('aduan/langsung?type=terjawab')}}">
                        ...
                        <li>
                          ...
                          <div class="tb-list-number">
                            <!-- <a href="{{url('aduan/langsung?type=spam')}}"> -->
                            {{$stats['data'][$i]['SPAM']}}
                            <!-- </a> -->
                          </div>
                        </li>
            ...
            <div class="tb-card tb-style1 tb-height-auto">
              ...
              <div class="tb-card-body">
                <div class="tb-padd-lr-30">
                  ...
                  <form method="GET" action="{{route('aduan','langsung')}}" id="formFilter" name="formFilter">
                  <!--   @csrf -->
                  <div class="form-row">
        ...
        <form id="frmDisposisi" name="frmDisposisi" action="{{route('postComment')}}" method="POST">
          @csrf
           <div class="tb-height-lg-b20"></div>
            ...
            <input type="hidden" id="type_aduan" value="langsung" name="type_aduan">
...
<!-- Modal -->
<div class="modal fade" id="modal-tambah-aduan" tabindex="-1" role="dialog" aria-labelledby="myLargeModalLabel" aria-hidden="true">
  <div class="modal-dialog modal-dialog-centered modal-lg">
    <div class="modal-content">
      <div class="modal-header modal-header-sos">
        <h5 class="modal-title" id="myLargeModalLabel">
          <i class="lni lni-email-original icon-tweet"></i> Tambah Aduan Manual
        </h5>
        <button type="button" class="close" data-dismiss="modal" aria-label="Close">
          <span aria-hidden="true">×</span>
        </button>
      ...
      <div class="modal-body">
        <form id="frmTambahAduanManual" name="frmTambahAduanManual" action="{{route('tambahAduanManual')}}" method="POST">
                  @csrf
                   <div class="tb-height-lg-b20"></div>

                    <input type="hidden" name="aduan_type" id="aduan_type" value="langsung">
                    ...
                    <div class="form-group">
                      <label for="exampleFormControlSelect1">Asal Provinsi</label>
        ...
        <button type="button" class="btn btn-modal-email-danger" data-dismiss="modal">Batal</button>
        {{-- <button type="button" class="btn btn-modal-email">Draft</button> --}}
        <button type="button" id="btnProcess" name="btnAduanManual" onclick="sendAduanManual('#frmTambahAduanManual')" class="btn btn-modal-email">Simpan</button>
      </div>
    </div>
    ...
    function post_feeds(id, comment){
      ...
      $.ajax({
        ...
        success: function(res){
           setTimeout(function() { showFlashAlert('success', 'Berhasil membalas kepada penanya'); }, 100);
     ...
     function modal_tambah_aduan(){
        $('#modal-tambah-aduan').modal({backdrop: 'static', keyboard: false});
    }
