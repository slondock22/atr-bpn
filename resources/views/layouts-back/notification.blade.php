            ...
            <ul class="tb-nofify-list tb-style1 tb-mp0">
             {{--  <li>
                <div class="tb-nofify-list-in">
                  ...
                  <div class="tb-nofify-text">
                    <h3 class="tb-nofify-text-head">Invite your <a href="#">friends</a> to <a href="#">dashboard.</a></h3>
              ...
              <li>
                <div class="tb-nofify-list-in">
                  ...
                  <div class="tb-nofify-text">
                    <h3 class="tb-nofify-text-head"><a href="#">3 Tasks</a> pending <a href="#">this month</a>.</h3>
              ...
              <li>
                <div class="tb-nofify-list-in">
                  ...
                  <div class="tb-nofify-text">
                    <h3 class="tb-nofify-text-head">7 People loved your <a href="#">activity</a>.</h3>
              ...
              <li>
                <div class="tb-nofify-list-in">
                  ...
                  <div class="tb-nofify-text">
                    <h3 class="tb-nofify-text-head">John <a href="#">commented on</a> activity.</h3>
              ...
              <li>
                <div class="tb-nofify-list-in">
                  ...
                  <div class="tb-nofify-text">
                    <h3 class="tb-nofify-text-head">Click <a href="#">your picture</a> or add an <a href="#">account</a>.</h3>
